...
@section('content')
    <h2 class="mb-5 text-4xl font-semibold text-gray-900 dark:text-gray-100">Halaman Pengambilan!</h2>
    <p class="mb-3 text-base">Ini adalah halaman yang digunakan untuk mendata pengambilan dokumen seorang debitur. </p>
    <p class="text-base">
        Cara menggunakan halaman pengambilan:
    </p>
    <ol class="max-w-full list-inside list-decimal space-y-1 text-base dark:text-gray-400">
        ...
        <li>
            Jika dokumen berstatus <span class="font-bold">Tersedia</span>, maka dokumen dapat diambil.
        </li>
        <li>
            Isi semua bagian yang terdapat pada bagian bawah tabel. Pastikan Anda telah memilih semua dokumen.
        </li>
        <li>
            Simpan pengambilan dengan menekan tombol <span class="font-bold">Submit</span>.
        </li>
        <li>
            Setelah dilakukan pengambilan, maka Anda dapat melihat:
            <ul class="mt-2 list-inside list-disc space-y-1 ps-5">
                <li>Berita Acara Serah Terima Pengambilan Dokumen</li>
                <li>Surat Roya</li>
                <li>Surat Pelunasan</li>
                <li>Berita Acara Serah Terima Pengambilan Dokumen dengan tanda tangan debitur</li>
            </ul>
        </li>
    </ol>
@endsection
