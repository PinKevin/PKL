...
@section('page_title')
    Bantuan Pengembalian
@endsection

@section('content')
    <h2 class="mb-5 text-4xl font-semibold text-gray-900 dark:text-gray-100">Halaman Pengembalian!</h2>
    <p class="mb-3 text-base">Ini adalah halaman yang digunakan untuk mendata pengembalian dokumen seorang debitur. </p>
    <p class="text-base">
        Cara menggunakan halaman pengembalian:
    </p>
    <ol class="max-w-full list-inside list-decimal space-y-1 text-base dark:text-gray-400">
        ...
        <li>
            Jika dokumen berstatus <span class="font-bold">Dipinjam</span>, maka dokumen dapat dikembalikan.
        </li>
        <li>
            Isi semua bagian yang terdapat pada bagian bawah tabel.
        </li>
        <li>
            Simpan pengembalian dengan menekan tombol <span class="font-bold">Submit</span>.
        </li>
        <li>
            Untuk melihat pengembalian-pengembalian yang dilakukan, tekan bagian
            <span class="font-bold">
                Riwayat Pengembalian</span>.
        </li>
    </ol>
@endsection
