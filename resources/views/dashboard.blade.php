    ...
    @if (auth()->user()->roles->first()->permissions->contains('group', 'transaksi'))
        <div class="relative mt-8 overflow-x-auto shadow-md sm:rounded-lg">
            <table class="w-full text-left text-sm text-gray-700 rtl:text-right dark:text-gray-400">
                ...
                <thead
                    class="border-b-2 border-gray-300 bg-slate-200 text-xs uppercase text-gray-700 dark:bg-gray-700 dark:text-gray-400">
                    <tr>
                ...
                <tbody>
                    @if ($bastPeminjaman->isEmpty())
                        <tr class="border-b-2 border-gray-300 bg-gray-50 text-center dark:border-gray-700 dark:bg-gray-800">
        ...
        <div class="mt-8 rounded-lg bg-gray-50">
            <div
                class="flex w-full items-center justify-center rounded-lg border-2 border-gray-300 p-4 dark:border-gray-700">
                <div
