    ...
    <div class="relative max-h-full w-full max-w-md p-4">
        ...
        <div class="relative rounded-lg bg-blue-600 shadow dark:bg-gray-700">
            ...
            <form class="rounded-b-md bg-slate-100 p-4 md:p-5" wire:submit.prevent="updateUser" method="POST">
                ...
                <button
                    class="inline-flex w-full items-center rounded-lg bg-blue-700 px-[154px] py-2.5 text-center text-sm font-medium text-white hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 sm:w-auto"
                    type="submit">
