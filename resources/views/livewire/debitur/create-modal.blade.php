...
{{-- <div class="fixed left-0 right-0 top-0 z-50 hidden h-[calc(100%-1rem)] max-h-full w-full items-center justify-center overflow-y-auto overflow-x-scroll shadow-lg md:inset-10"
    ...
    <div class="relative max-h-full w-full max-w-md p-4">
        ...
        <div class="relative rounded-lg bg-blue-600 shadow dark:bg-gray-700">
            ...
            <!-- Modal body -->
            <form class="rounded-b-md bg-slate-100 p-4 md:p-5" wire:submit.prevent="createDebitur" method="POST">
                <div class="mb-4 grid grid-cols-2 gap-4">
                    <div class="col-span-2">
                        ...
                        <input
                            ...
                            id="no_debitur" name="no_debitur" type="text" aria-describedby="helper-nomor-debitur"
                        ...
                        <p class="mt-0.5 text-sm text-gray-500 dark:text-gray-400" id="helper-nomor-debitur">
                            Pastikan nomor debitur sudah benar.
                        </p>
                        @error('no_debitur')
                ...
                <button
                    class="inline-flex items-center rounded-lg bg-blue-700 px-[127px] py-2.5 text-center text-sm font-medium text-white hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                    type="submit">
...
<div class="fixed left-0 right-0 top-0 z-50 hidden h-[calc(100%-1rem)] max-h-full w-full overflow-y-auto overflow-x-hidden p-4 md:inset-0"
    ...
    <div class="relative max-h-full w-full max-w-7xl">
        ...
        <div class="relative rounded-lg bg-white shadow dark:bg-gray-700">
            ...
            <!-- Modal footer -->
            <div
                class="flex items-center space-x-3 rounded-b border-t border-gray-200 p-4 rtl:space-x-reverse dark:border-gray-600 md:p-5">
                <button
                    class="rounded-lg bg-blue-700 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                    data-modal-hide="create-modal" type="button">I accept</button>
                <button
                    ...
                    data-modal-hide="create-modal" type="button">Decline</button>
            </div>
        </div>
    </div>
</div>
