<div>
    ...
    <hr class="h-2 my-8 bg-slate-300 rounded-md dark:bg-gray-700">

    {{-- <div class="p-4 sm:ml-64"> --}}
    {{-- <div class="border-gray-900"> --}}
    {{-- <div class="mt-14 rounded-md bg-gray-500 p-3 dark:border-gray-700"> --}}
    <h2 class="mb-3 text-4xl inline-flex  font-semibold text-gray-900 dark:text-gray-100">Daftar Berkas</h2>
    {{-- </div> --}}
    {{-- </div> --}}
    {{-- </div> --}}
    ...
    <div id="accordion-open" data-accordion="open">
        @forelse ($dokumen as $dok)
            ...
            <div class="hidden" id="accordion-open-body-{{ $loop->index }}"
                ...
                <div class="border-2 border-b-2 bg-gray-100 border-gray-200 p-5 dark:border-gray-700 dark:bg-gray-900">
                    ...
                    <table
                        class=" w-full border-3 text-left relative overflow-x-auto shadow-md sm:rounded-md text-sm text-gray-500 rtl:text-right dark:text-gray-400">
                        <thead
                            class="bg-blue-400 text-xs border-b uppercase text-gray-900 dark:bg-gray-700 dark:text-gray-400">
                            <tr>
                    ...
                    <table
                        class=" mt-3 w-flex border-3 text-left relative overflow-x-auto shadow-md sm:rounded-md text-sm text-gray-500 rtl:text-right dark:text-gray-400">
                        <thead
                            class="bg-blue-400 text-xs border-b uppercase text-gray-900 dark:bg-gray-700 dark:text-gray-400">
                            <tr>
                                <th class="px-4 py-3 " scope="col">
