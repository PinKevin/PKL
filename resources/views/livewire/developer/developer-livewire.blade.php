<div>
    ...
    @endif
    <h2 class="text-4xl font-semibold text-gray-900 dark:text-gray-100">Daftar Developer</h2>
    ...
    @include('livewire.developer.create-modal')
    @include('livewire.developer.edit-modal')
    @include('livewire.developer.show-modal')
    @include('livewire.developer.delete-modal')
            ...
            <thead class="bg-slate-300 text-xs uppercase text-gray-700 dark:bg-gray-700 dark:text-gray-400">
                <tr>
                    ...
                    <th class="px-7 py-4" scope="col">
                        <button class="flex items-center uppercase" wire:click="sortResult('kode_developer')">
                            Kode Developer
                    ...
                    <th class="px-7 py-4" scope="col">
                        <button class="flex items-center uppercase" wire:click="sortResult('nama_developer')">
                            Nama Developer
                            <svg class="ms-1.5 h-3 w-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                fill="currentColor" viewBox="0 0 24 24">
                                <path
                ...
                @forelse ($developer as $db)
                    <tr
                        ...
                        <th class="whitespace-nowrap px-6 py-4 font-medium text-gray-900 dark:text-white"
                            scope="row">
                            {{ $loop->index + $developer->firstItem() }}
                        </th>
                        <td class="px-7 py-4">
                            {{ $db->kode_developer }}
                        </td>
                        ...
                        <td class="flex justify-between px-6 py-4">
                            <button id="button-show-modal" data-modal-target="show-modal"
                                ...
                                wire:click="showDeveloper({{ $db->id }})">
                            ...
                            <button id="button-edit-modal" data-modal-target="edit-modal"
                                ...
                                wire:click="editDeveloper({{ $db->id }})">
                            ...
                            <button id="button-delete-modal" data-modal-target="delete-modal"
                                ...
                                wire:click="deleteDeveloper({{ $db->id }})">
