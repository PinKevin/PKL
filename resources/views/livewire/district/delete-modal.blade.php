<div class="fixed left-0 right-0 top-0 z-50 hidden h-[calc(100%-1rem)] max-h-full w-full items-center justify-center overflow-y-auto overflow-x-hidden md:inset-0"
    id="delete-modal" tabindex="-1" wire:ignore.self>
    <div class="relative max-h-full w-full max-w-md p-4">
        <div class="relative rounded-lg bg-white shadow dark:bg-gray-700">
            <button
                class="absolute end-2.5 top-3 ms-auto inline-flex h-8 w-8 items-center justify-center rounded-lg bg-transparent text-sm text-gray-400 hover:bg-gray-200 hover:text-gray-900 dark:hover:bg-gray-600 dark:hover:text-white"
                id="close-delete-modal" data-modal-hide="delete-modal" type="button">
            ...
            <div class="p-4 text-center md:p-5">
                ...
                <h3 class="mb-5 text-lg font-normal text-gray-700 dark:text-gray-400">
                    Yakin ingin hapus kecamatan {{ $name }}?
                </h3>
                <button
                    ...
                    data-modal-hide="delete-modal" type="button" wire:click="destroyDistrict()">
                    Ya, hapus data
                </button>
                <button
                    class="rounded-lg border border-gray-200 bg-white px-5 py-2.5 text-sm font-medium text-gray-500 hover:bg-gray-100 hover:text-gray-900 focus:z-10 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:border-gray-500 dark:bg-gray-700 dark:text-gray-300 dark:hover:bg-gray-600 dark:hover:text-white dark:focus:ring-gray-600"
                    data-modal-hide="delete-modal" type="button">Tidak</button>
            </div>
        </div>
    </div>
</div>
