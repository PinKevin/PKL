...
<div class="fixed left-0 right-0 top-0 z-50 hidden h-[calc(100%-1rem)] max-h-full w-full items-center justify-center overflow-y-auto overflow-x-hidden shadow-lg md:inset-0"
    ...
    <div class="relative max-h-full w-full max-w-md p-4">
        ...
        <div class="relative rounded-lg bg-blue-600 shadow dark:bg-gray-700">
            ...
            <!-- Modal body -->
            <form class="rounded-b-md bg-slate-100 p-4 md:p-5" wire:submit.prevent="createPermission" method="POST">
                <div class="mb-4 grid grid-cols-2 gap-4">
                    <div class="col-span-2">
                        ...
                        <input
                            ...
                            id="name" name="name" type="text" placeholder="Nama Izin" wire:model="name" />
                        @error('name')
                    ...
                    <div class="col-span-2">
                        ...
                        <select
                            ...
                            id="group" name="group" wire:model="group">
                ...
                <button
                    class="inline-flex w-full items-center rounded-lg bg-blue-700 px-[155px] py-2.5 text-center text-sm font-medium text-white hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 sm:w-auto"
                    type="submit">
