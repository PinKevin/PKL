<div>
    ...
    @endif
    <h2 class="text-4xl font-semibold text-gray-900 dark:text-gray-100">Kelola Izin</h2>
    ...
    @include('livewire.izin.create-modal')
    @include('livewire.izin.edit-modal')
    {{-- @include('livewire.akun.show-modal') --}}
    @include('livewire.izin.delete-modal')
        ...
        <table class="w-full text-left text-sm text-gray-500 rtl:text-right dark:text-gray-400">
            <thead class="bg-slate-300 text-xs uppercase text-gray-700 dark:bg-gray-700 dark:text-gray-400">
                <tr>
                    ...
                    <th class="px-7 py-4" scope="col">
                        <button class="flex items-center uppercase" wire:click="sortResult('group')">
                            Grup
                            <svg class="ms-1.5 h-3 w-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                fill="currentColor" viewBox="0 0 24 24">
                                <path
                ...
                @forelse ($permissions as $p)
                    <tr
                        ...
                        <th class="whitespace-nowrap px-6 py-4 font-medium text-gray-900 dark:text-white"
                            scope="row">
                            {{ $loop->index + $permissions->firstItem() }}
                        </th>
                        <td class="px-7 py-4">
                            {{ $p->name }}
                        </td>
                        ...
                        <td class="flex justify-between px-6 py-4">
                            {{-- <button id="button-show-modal" data-modal-target="show-modal" data-modal-toggle="show-modal"
                                type="button" wire:click="showUser({{ $p->id }})">
                            ...
                            <button id="button-edit-modal" data-modal-target="edit-modal"
                                ...
                                wire:click="editPermission({{ $p->id }})">
                            ...
                            <button id="button-delete-modal" data-modal-target="delete-modal"
                                ...
                                wire:click="deletePermission({{ $p->id }})">
