<div>
    ...
    @include('livewire.peminjaman-dokumen.bast-log')

    @include('livewire.peminjaman-dokumen.show-dokumen')
    ...
    @if (in_array('SHT', $checkedDokumen))
        @include('livewire.peminjaman-dokumen.surat-roya-form')
    @endif

    @include('livewire.peminjaman-dokumen.bast-peminjaman-form')
