...
<div class="fixed left-0 right-0 top-0 z-50 hidden h-[calc(100%-1rem)] max-h-full w-full overflow-y-auto overflow-x-hidden p-4 md:inset-0"
    ...
    <div class="relative max-h-full w-full max-w-4xl">
        ...
        <div class="relative rounded-lg bg-white shadow dark:bg-gray-700">
            <!-- Modal header -->
            <div
                class="flex items-center bg-blue-600 justify-between rounded-t border-b p-4 dark:border-gray-600 md:p-3">
            ...
            <div class="bg-slate-100 space-y-4 p-4 md:p-5">
                ...
                <form wire:submit.prevent="updateDokumen">
                    ...
                    <button
                        class="inline-flex w-full items-center justify-center rounded-lg bg-blue-700 px-[154px] py-2.5 text-center text-sm font-medium text-white hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                        type="submit">
