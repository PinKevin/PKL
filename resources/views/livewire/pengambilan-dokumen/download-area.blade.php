            ...
            <div
                ...
                @if ($suratRoya)
                    <button
                        ...
                        <a class="flex items-center" href="{{ route('surat-roya.cetak', ['id' => $suratRoya->id]) }}">
                            Cetak Roya
                        </a>
                    </button>
                @endif
                @if ($pelunasan)
                    <button
                        class="flex rounded-lg bg-green-700 px-5 py-2 text-sm font-medium text-white hover:bg-green-800 focus:outline-none focus:ring-4 focus:ring-green-300 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800"
                        id="button-show-pelunasan" data-modal-target="show-pelunasan" data-modal-toggle="show-pelunasan"
                        type="button">
                        Lihat Pelunasan
                    </button>
                    ...
                    <div class="fixed left-0 right-0 top-0 z-50 hidden h-[calc(100%-1rem)] max-h-full w-full items-center justify-center overflow-y-auto overflow-x-hidden md:inset-9"
                        ...
                        <div class="relative max-h-full w-full max-w-4xl p-4">
                            ...
                            <div class="relative rounded-lg bg-blue-600 shadow dark:bg-gray-700">
                                ...
                                <!-- Modal body -->
                                <embed src="/storage/{{ $bastTtd->file_bast }}" type="application/pdf" width="100%"
                                    height="600">
                            </div>
                        </div>
                    </div>
