<div>
    ...
    @endif
    <h2 class="text-4xl font-semibold text-gray-900 dark:text-gray-100">Daftar Staff Cabang</h2>
    ...
    @include('livewire.staff-cabang.create-modal')
    @include('livewire.staff-cabang.edit-modal')
    @include('livewire.staff-cabang.show-modal')
    @include('livewire.staff-cabang.delete-modal')
            ...
            <thead class="bg-slate-300 text-xs uppercase text-gray-700 dark:bg-gray-700 dark:text-gray-400">
                <tr>
                    ...
                    <th class="px-7 py-4" scope="col">
                        <button class="flex items-center uppercase" wire:click="sortResult('nip')">
                            NIP
                    ...
                    <th class="px-7 py-4" scope="col">
                        <button class="flex items-center uppercase" wire:click="sortResult('kantor')">
                            Kantor
                            <svg class="ms-1.5 h-3 w-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                fill="currentColor" viewBox="0 0 24 24">
                                <path
                    ...
                    <tr
                        ...
                        <td class="flex justify-between px-6 py-4">
                            <button id="button-show-modal" data-modal-target="show-modal"
                                ...
                                wire:click="showStaffCabang({{ $s->id }})">
                            ...
                            <button id="button-edit-modal" data-modal-target="edit-modal"
                                ...
                                wire:click="editStaffCabang({{ $s->id }})">
