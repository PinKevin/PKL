<div>
    <h2 class="text-4xl font-semibold text-gray-900 dark:text-gray-100">Edit Surat Roya</h2>

    <form class="ml-0.5 mt-4" wire:submit.prevent="updateSuratRoya" method="POST">
        ...
        <div class="flex items-center justify-start">
            ...
            <a class="ml-2 w-full inline-flex items-center rounded-lg bg-gray-500 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-gray-600 focus:outline-none focus:ring-4 focus:ring-gray-300 dark:bg-gray-600 dark:hover:bg-gray-700 dark:focus:ring-gray-800 sm:w-auto"
