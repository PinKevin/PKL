...
<div class="fixed left-0 right-0 top-0 z-50 hidden h-[calc(100%-1rem)] max-h-full w-full items-center justify-center overflow-y-auto overflow-x-hidden shadow-lg md:inset-0"
    ...
    <div class="relative max-h-full w-full max-w-md p-4">
        ...
        <div class="relative rounded-lg bg-blue-600 shadow dark:bg-gray-700">
            ...
            <!-- Modal body -->
            <form class="rounded-b-md bg-slate-100 p-4 md:p-5" wire:submit.prevent="updateVillage" method="POST">
                <div class="mb-4 grid grid-cols-2 gap-4">
                    <div class="col-span-2">
                        <label class="mb-1 ml-1 block text-sm font-medium text-gray-900 dark:text-white"
                            for="code">Kode Kelurahan
                        </label>
                        <input
                            ...
                            aria-describedby="helper-nomor-developer" disabled placeholder="Kode Kelurahan"
                            wire:model="code" maxlength="10" pattern="[0-9]*" />
                    </div>
                    <div class="col-span-2">
                        <label class="mb-1 ml-1 block text-sm font-medium text-gray-900 dark:text-white"
                            for="regency_id">
                        ...
                        <select
                            ...
                            id="regency_id" name="regency_id" wire:model.change="regency_id">
                    ...
                    <div class="col-span-2">
                        ...
                        <select
                            ...
                            @foreach ($districtList as $d)
                                <option value="{{ $d->id }}" @if ($district_id == $d->id) selected @endif>
                                    {{ $d->name }}</option>
                            @endforeach
                        </select>
                        @error('district_id')
                    ...
                    <div class="col-span-2">
                        ...
                        <input
                            ...
                            id="name" name="name" type="text" placeholder="Nama Kelurahan"
                            wire:model="name" />
                        @error('name')
                            <div class="mb-4 mt-1 flex items-center rounded-lg border-t-4 border-red-400 bg-red-100 p-3 text-red-800 dark:border-red-800 dark:bg-gray-800 dark:text-red-400"
                                role="alert">
