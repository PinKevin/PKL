<div>
    ...
    @endif
    <h2 class="text-4xl font-semibold text-gray-900 dark:text-gray-100">Daftar Kelurahan Jawa Tengah</h2>
    ...
    @include('livewire.village.create-modal')
    @include('livewire.village.edit-modal')
    @include('livewire.village.show-modal')
    @include('livewire.village.delete-modal')
